...
class BunnyCDNAdapter extends AbstractAdapter
{
    ...
    protected function normalizeObject(array $bunny_file_array): array
    {
        return [
            ...
            'timestamp' => (date_create_from_format('Y-m-d\TH:i:s.u', $bunny_file_array['LastChanged'].'000') ?: new DateTime())->getTimestamp(),
            'server_id' => $bunny_file_array['ServerId'],
            'user_id' => $bunny_file_array['UserId'],
            'last_changed' => (date_create_from_format('Y-m-d\TH:i:s.u', $bunny_file_array['LastChanged'].'000') ?: new DateTime())->getTimestamp(),
            'date_created' => (date_create_from_format('Y-m-d\TH:i:s.u', $bunny_file_array['DateCreated'].'000') ?: new DateTime())->getTimestamp(),
